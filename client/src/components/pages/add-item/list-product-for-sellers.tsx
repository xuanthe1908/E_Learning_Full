...
const ListCourseForsellers: React.FC = () => {
  // const [products, setProducts] = useState<
  //   GetProductBySellerInterface[] | null
  // >(null);
  const [products, setProducts] = useState<GetProductBySellerInterface[]>([]);
  ...
  const searchResult = useSearch(products, searchQuery);
  const fetData = async () => {
    // ✅ Mock Mode
    if (USE_MOCK_DATA) {
      setTimeout(() => {
                  ...
                  if (index <= 4) {
                    return (
                      <tr key={_id}>
                        ...
                        <td className={classes}>
                          <Tooltip content='Add items'>
                            <Link to={`/sellers/view-items/${_id}`}>
                          ...
                          <Tooltip content='Edit product'>
                            <Link to={`/sellers/edit-product/${_id}`}>
                            <IconButton variant='text' color='blue-gray'>
...
export default ListCourseForsellers;
