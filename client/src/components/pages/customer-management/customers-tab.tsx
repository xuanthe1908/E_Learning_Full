...
export default function CustomersTab() {
  ...
  const tabComponents: { [key: string]: JSX.Element } = {
    all: <Viewcustomers updated={updated} setUpdated={setUpdated}/>, // Replace with the component you want to show for "All customers"
    blocked: <Blockedcustomers updated={updated} setUpdated={setUpdated} />, // Replace with the component you want to show for "Blocked"
