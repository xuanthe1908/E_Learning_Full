...
import { addDiscussion } from "../../../api/endpoints/product/discussion";
import { toast } from "react-toastify";
import { BeatLoader } from "react-spinners";
import { getDiscussionsByLesson } from "../../../api/endpoints/product/discussion";
import { ApiResponseDiscussion } from "../../../api/types/apiResponses/api-response-discussion";
import { useSelector } from "react-redux";
import { selectIsLoggedIn } from "../../../redux/reducers/authSlice";

const Discussion: React.FC<{ itemId: string }> = ({ itemId }) => {
  ...
  const handlePostDiscussion = async () => {
    try {
      setIsLoading(true);
      const response = await addDiscussion(itemId ?? "", discussionText);
      setUpdated(!updated);
  ...
  const fetchDiscussions = async (itemId:string) => {
    try {
      const response = await getDiscussionsByLesson(itemId);
