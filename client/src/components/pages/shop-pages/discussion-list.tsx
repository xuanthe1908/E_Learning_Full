...
import { deleteDiscussions } from "../../../api/endpoints/product/discussion";
import { toast } from "react-toastify";
import { getRepliesByDiscussion } from "../../../api/endpoints/product/discussion";
import { SyncLoader } from "react-spinners";
import { ApiResponseDiscussionReply } from "../../../api/types/apiResponses/api-response-discussion";
import { IoSend } from "react-icons/io5";
import { replyDiscussions } from "../../../api/endpoints/product/discussion";
...
const DiscussionListEl: React.FC<Props> = ({
  ...
  const isEditable = customerId === studentDetails._id;
