...
import { registerSeller } from "../../../api/endpoints/auth/seller-auth";
import { SellerRegistrationValidationSchema } from "../../../validations/auth/SellerRegisterValidation";
import { PhotoIcon } from "@heroicons/react/24/solid";
import { SellerRegisterDataInterface } from "../../../api/types/seller/auth-interface";
...
const SellerRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (
    instructorInfo: SellerRegisterDataInterface,
    { resetForm }: FormikHelpers<SellerRegisterDataInterface>
  ) => {
    try {
      setIsUploading(true);
