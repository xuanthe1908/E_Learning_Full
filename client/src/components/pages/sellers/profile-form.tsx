...
import { getSellerDetails, updateProfile } from "../../../api/endpoints/seller";
import { UpdateProfileInfo } from "../../../api/types/seller/seller";
  ...
  useEffect(() => {
    if (seller) {
      formik.setValues({
        ...
        qualification: seller?.qualification || "",
        // subjects: seller?.subjects || "",
        experience: seller?.experience || "",
        skills: seller?.skills || "",
        about: seller?.about || "",
      });
    }
    setProfileUrl(seller?.profileUrl ?? "");
  }, [seller]);
