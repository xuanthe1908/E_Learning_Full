...
import {
  unblockSellers,
} from "../../../api/endpoints/seller-management";
import { toast } from "react-toastify";
import { formatDate } from "../../../utils/helpers";
import usePagination from "../../../hooks/usePagination";
import { getBlockedSellers } from "../../../api/endpoints/seller-management";
...
const ViewBlockedsellers: React.FC = () => {
  ...
  const fetchBlockedsellers = async () => {
    ...
    try {
      ...
      console.error("Error fetching blocked sellers:", error);
  ...
  const handleUnblock = async (sellerId: string) => {
    try {
      const response = await unblockSellers(sellerId);
        ...
        <div className='mb-4 flex flex-col justify-between gap-8 md:flex-row md:items-center'>
          <div>
            ...
            <Typography color='gray' className='mt-1 font-normal'>
              These are details about the sellers
            </Typography>
          </div>
...
export default ViewBlockedsellers;
