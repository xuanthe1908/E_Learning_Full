...
import { registerCustomer } from "../../../api/endpoints/auth/customer-auth";
import { CustomerRegistrationValidationSchema } from "../../../validations/auth/customerRegisterValidation";
...
const CustomerRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (customerInfo: CustomerData) => {
    try {   
       await registerCustomer(customerInfo);   
      ...
      <div className="flex justify-center items-center h-screen text-customFontColorBlack">
        <div className="bg-white rounded-lg mx-4 sm:mx-auto md:mx-auto pt-10 lg:mx-auto shadow-xl p-4 sm:p-10 md:p-8 lg:p-10 w-full max-w-xl border">
          ...
          <Formik
            ...
            validationSchema={CustomerRegistrationValidationSchema}
