...
import { updateProfile } from "../../../api/endpoints/customer";
import { UpdateProfileInfo } from "../../../api/types/customer/customer";
...
const ProfileForm:React.FC<Props> = ({editMode,setEditMode}) => {
  ...
  const customerInfo = useSelector(selectCustomer)?.customerDetails;
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  let isFetching = useSelector(selectIsFetchingCustomer);
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <div className='p-5 flex '>
        <Avatar
          src={previewImage || customerInfo?.profilePic?.url  ||USER_AVATAR}
          alt='avatar'
          size='xl'
        />
        <div className='pl-4'>
