...
const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  useEffect(() => {
    const loadVideo = async () => {
      ...
      console.log('Props:', { videoKey, isCoursePurchased });
      ...
      // Check if course is purchased and video key exists
          ...
          {process.env.NODE_ENV === 'development' && (
            <details className='text-left'>
              ...
              <div className='mt-2 p-2 bg-gray-100 text-xs rounded space-y-1'>
                ...
                <div><strong>Is Purchased:</strong> {String(isCoursePurchased)}</div>
      ...
      <div className='flex items-center justify-center h-64 bg-black bg-opacity-90 rounded-lg'>
        <div className='text-center text-white p-8'>
          ...
          <p className='text-lg text-gray-300 mb-4'>
            Please purchase the course to unlock this content
          </p>
          <button 
