...
export const mockProductsData: Omit<MockProductData, '_id' | 'instructorId' | 'coursesEnrolled'>[] = [
  {
    ...
    description: 'Dell XPS 15 9520 là laptop cao cấp với màn hình OLED 15.6 inch 4K, CPU Intel Core i7-12700H thế hệ 12, RAM 32GB DDR5, SSD 1TB NVMe. Thiết kế mỏng nhẹ chỉ 1.92kg, pin lên đến 12 giờ, card đồ họa NVIDIA RTX 3050 Ti. Hoàn hảo cho designer, developer và content creator.',
    syllabus: [
    ...
    introduction: {
      name: 'introduction-dell-xps-15.pdf',
      key: 'products/introduction-dell-xps-15.pdf',
      url: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=1200&h=800&fit=crop'
    },
    guidelines: {
      name: 'guidelines-dell-xps-15.pdf',
      key: 'products/guidelines-dell-xps-15.pdf',
      url: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=1200&h=800&fit=crop'
    },
    guidelinesUrl: 'https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=1200&h=800&fit=crop',
    rating: 4.8,
    isVerified: true,
  ...
  },
  {
    ...
    description: 'iPhone 15 Pro Max là flagship mới nhất của Apple với màn hình Super Retina XDR 6.7 inch, chip A17 Pro mạnh mẽ nhất, hệ thống camera 48MP chuyên nghiệp với zoom quang học 5x, pin lên đến 29 giờ video playback, hỗ trợ 5G, USB-C, và vỏ Titanium siêu nhẹ.',
    syllabus: [
  ...
  },
  {
    ...
    description: 'Samsung Galaxy Watch 6 Classic với màn hình AMOLED 1.4 inch, vòng bezel xoay vật lý, theo dõi nhịp tim, huyết áp, ECG, giấc ngủ, SpO2. Pin lên đến 2 ngày, chống nước IP68, tương thích Android và iOS, hỗ trợ Samsung Pay.',
    syllabus: [
  ...
  },
  {
    ...
    description: 'Sony WH-1000XM5 với công nghệ chống ồn chủ động V1 mới nhất, driver 30mm, hỗ trợ Hi-Res Audio, LDAC codec, pin lên đến 30 giờ, sạc nhanh 3 phút cho 3 giờ nghe nhạc. Touch controls, Google Assistant và Amazon Alexa tích hợp.',
    syllabus: [
  ...
  },
  {
    ...
    description: 'iPad Pro 12.9 inch với chip M2 mạnh mẽ, màn hình Liquid Retina XDR tuyệt đẹp, hỗ trợ Apple Pencil 2 và Magic Keyboard. RAM 8GB, SSD 256GB, camera 12MP với LiDAR, hỗ trợ 5G, WiFi 6E. Hoàn hảo cho công việc sáng tạo và học tập.',
    syllabus: [
  ...
  },
  {
    ...
    description: 'MacBook Pro 14 inch với chip M3 Pro mạnh mẽ, màn hình Liquid Retina XDR 14.2 inch, RAM 18GB unified, SSD 512GB. CPU 12-core, GPU 18-core, pin lên đến 18 giờ, Thunderbolt 4, MagSafe 3. Hiệu năng vượt trội cho công việc chuyên nghiệp.',
    syllabus: [
  ...
  },
  {
    ...
    description: 'AirPods Pro 2 với chip H2, chống ồn chủ động cải tiến, chất âm Spatial Audio, Adaptive Audio, pin lên đến 6 giờ (30 giờ với hộp), hộp sạc USB-C, MagSafe charging. Tương thích hoàn hảo với Apple devices.',
    syllabus: [
      'Kết nối và cài đặt',
  ...
  },
  {
    ...
    description: 'Canon EOS R6 Mark II với cảm biến full-frame 24.2MP, quay video 4K 60fps, chụp liên tiếp 40fps, ổn định hình ảnh 5 trục, màn hình cảm ứng xoay 3.2 inch, viewfinder OLED 3.69M dots, dual card slots (CFexpress + SD).',
    syllabus: [
