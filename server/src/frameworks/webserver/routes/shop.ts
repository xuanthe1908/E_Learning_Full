...
import { shopDbRepository } from '../../../app/repositories/shopDbRepository';
import { shopRepositoryMongodb } from '../../../frameworks/database/mongodb/repositories/shopRepoMongoDb';
import { openAiService } from '../../../frameworks/services/openAiService';
import jwtAuthMiddleware from '../middlewares/userAuth';
import { shopRateLimit, createChatRateLimit } from '../middlewares/rateLimitMiddleware';
...
const shopRouter = () => {
  ...
  const controller = shopController(
    shopDbRepository,
    shopRepositoryMongodb(),
    aiServiceInstance
  );
  ...
  router.post('/:chatId/message', shopRateLimit, controller.sendMessage);
