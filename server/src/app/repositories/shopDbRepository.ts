...
export const shopDbRepositoryInterface = () => {
  return {
...
export const shopDbRepository = (repository: ReturnType<typeof shopDbRepositoryInterface>) => {
...
export type ShopDbInterface = typeof shopDbRepository;
