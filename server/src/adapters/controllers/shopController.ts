...
import { createShop } from '../../entities/shopEntity';
...
const shopController = (
  shopDbRepository: ShopDbInterface,
  shopDbImpl: ReturnType<ShopDbInterface>,
  aiService: any
) => {
  const dbRepository = shopDbRepository(shopDbImpl);
